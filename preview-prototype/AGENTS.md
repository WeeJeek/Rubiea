...
- Keep the desktop Hero `Rubiae Moments` feature as one tall off-white paper sheet rotated about `3deg` clockwise, with its live copy and photo contained inside; keep the mobile card unrotated in normal flow after the Hero image.
