...
- **Open:** Final desktop visual composition, random-entry appearance and trigger, anonymous URL/search/redaction boundaries, authorised Stone archive card, implementation, and interaction tests remain under `GEM-009`.
