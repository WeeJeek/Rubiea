...
- **Open:** Final desktop visual composition, random-entry plus back/repeat-control appearance, anonymous URL/search/zero- and single-story/redaction boundaries, authorised Stone archive card, implementation, and interaction tests remain under `GEM-009`.
