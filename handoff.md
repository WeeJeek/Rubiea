...
- **Open:** Final desktop visual composition, random-entry appearance, selected-story destination, repeat-random behaviour, anonymous URL/search/empty/redaction boundaries, authorised Stone archive card, implementation, and interaction tests remain under `GEM-009`.
